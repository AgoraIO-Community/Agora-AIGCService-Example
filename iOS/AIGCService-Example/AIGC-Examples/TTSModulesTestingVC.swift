...
class TTSModulesTestingVC: UIViewController, AgoraAIGCServiceDelegate, RtcManagerDelegate, LLMModulesTestingViewDelegate {
    let mainView = LLMModulesTestingView()
